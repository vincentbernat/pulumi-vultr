...
class GetPlanResult:
    ...
    """
    def __init__(__self__, bandwidth=None, disk=None, disk_count=None, filters=None, id=None, locations=None, monthly_cost=None, ram=None, type=None, vcpu_count=None):
