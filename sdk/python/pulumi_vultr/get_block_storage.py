...
class GetBlockStorageResult:
    ...
    """
    def __init__(__self__, attached_to_instance=None, cost=None, date_created=None, filters=None, id=None, label=None, mount_id=None, region=None, size_gb=None, status=None):
