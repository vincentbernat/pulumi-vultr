...
func (o LookupBareMetalServerResultOutput) MacAddress() pulumi.StringOutput {
	return o.ApplyT(func(v LookupBareMetalServerResult) string { return v.MacAddress }).(pulumi.StringOutput)
}
...
// The server's tag.
func (o LookupBareMetalServerResultOutput) Tag() pulumi.StringOutput {
	return o.ApplyT(func(v LookupBareMetalServerResult) string { return v.Tag }).(pulumi.StringOutput)
}
